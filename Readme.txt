...
INTRODUCTION
Pak128.Sweden-Ex is a graphics set (pak) for Simutrans Extended. It requires a Simutrans Extended (S.E.) executable in order to play.
...
TECHNICAL ISSUES
If there are any technical issues (e.g. error messages, crashes) please make a post in "bugs" board of the Simutrans Extended Forum - http://forum.simutrans.com/index.php?board=53.0 - Please also state which version of the Simutrans executable you are using and which operating system.

If you encounter any bugs by the pak itself (graphical glitches, missing objects etc), please remember that it is in construction state and then make instead a similar post in the Swedish pakset development forum: http://forum.simutrans.com/index.php?board=144.0

GAMEPLAY NOTES
This pak is currently in "pre alfa" state, meaning its not playable as a game for the moment. Many key features, such as economy, factories, many vehicles etc are yet to be added to the pak before it makes sence as a playable game. However, it should compile and the things currently added should work as intended ingame.
Do note however, that any games saved with this pakset, might not be compatible with future releases!



If you have any notes, suggestions for improvements, or if you want to help developing this pakset, feel free to post in the Swedish pakset development forum: http://forum.simutrans.com/index.php?board=144.0
or in the Swedish section of the forum (English language is allowed!): http://forum.simutrans.com/index.php?board=22.0